...
int input_init(
  ...
  //                                       cs_background, cs_background, cs_background, cs_nonlinear,cs_nonlinear_pt,cs_background,cs_background};
...
enum computation_stage target_cs[] = {cs_background,cs_background,cs_thermodynamics, cs_background, cs_background, cs_background, cs_background, cs_background, cs_nonlinear,cs_nonlinear_pt};
...
int input_try_unknown_parameters(double * unknown_parameter,
  ...
  if (pfzw->required_computation_stage >= cs_nonlinear){
    ...
    class_call_except(nonlinear_pt_init(&pr,&ba,&th,&pt,&pm,&nlpt),
                      nlpt.error_message,
                      errmsg,
                      primordial_free(&pm);perturb_free(&pt);thermodynamics_free(&th);background_free(&ba)
                      );
