...
/* EDE-edit: potential of the EDE field.
 ...
 Here A=axion mass is units of eV, alpha=f= axion decay constant in units of eV, phi field in units of m_pl. The overall factor of 3911.22 arises from unit conversion. B is the CC.
 
 V_e is the scf potential without the CC. */

/* EDE-edit Dec 20: fixed units conversion prefactor: 3911.22-->4152.39. Correction accounts for extra digits in kpc=3.086 10^19 meters,
and hbar c=1= 197.326 MeV fm . */
